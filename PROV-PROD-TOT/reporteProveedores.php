...
$pdf->Cell(30, 6, 'ID Proveedor', 1, 0, 'C', 1);
...
$sqlProductos = ("SELECT * FROM proveedor");
$query = mysqli_query($mysqli, $sqlProductos);

while ($dataRow = mysqli_fetch_array($query)) {
    $pdf->Cell(30, 6, ($dataRow['id_proveedor']), 1, 0, 'C');
    $pdf->Cell(40, 6, $dataRow['nombre'], 1, 0, 'C');
    $pdf->Cell(30, 6,  $dataRow['telefono'], 1, 0, 'C');
    $pdf->Cell(45, 6,  $dataRow['direccion'], 1, 0, 'C');
