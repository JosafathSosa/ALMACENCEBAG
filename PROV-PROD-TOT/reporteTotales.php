...
$pdf->SetTitle('Informe de Totales');
...
$pdf->Cell(100, 6, 'LISTA DE TOTALES', 0, 0, 'C');
...
$pdf->Cell(30, 6, 'ID Total', 1, 0, 'C', 1);
$pdf->Cell(40, 6, 'Producto', 1, 0, 'C', 1);
$pdf->Cell(30, 6, 'Cant Inicio', 1, 0, 'C', 1);
$pdf->Cell(30, 6, 'Cant Salida', 1, 0, 'C', 1);
...
$sqlProductos = ("SELECT * FROM totales");
$query = mysqli_query($mysqli, $sqlProductos);

while ($dataRow = mysqli_fetch_array($query)) {
    $pdf->Cell(30, 6, ($dataRow['id_total']), 1, 0, 'C');
    $pdf->Cell(40, 6, $dataRow['producto'], 1, 0, 'C');
    $pdf->Cell(30, 6,  $dataRow['cantidad_inicio'], 1, 0, 'C');
    $pdf->Cell(30, 6,  $dataRow['cantidad_salida'], 1, 0, 'C');
    $pdf->Cell(30, 6,  $dataRow['existencia'], 1, 1, 'C');
}
